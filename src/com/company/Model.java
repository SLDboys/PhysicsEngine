...
public class Model {
    final int AIR = 0,
            GROUND = 1,
            WATER = 2;
    final float maxMass = 1f,//The normal, un-pressurized mass of a full water cell
            maxCompress = 0.02f,//How much excess water a cell can store, compared to the cell above it
            minMass = 0.000001f,//Ignore cells that are almost dry
            minFlow = 5f,
            maxSpeed = 8f;
